...
def search_characteristic(breed_characteristic): 
    ...
    if breed_characteristic == 'barking':
        ...
        url2 = f'{API_BASE_URL}barking=1;offset=20'  # If there are more than 20 records for that characteristic,
                                                     #create the necessary additional endpoint url(s) to access all records
